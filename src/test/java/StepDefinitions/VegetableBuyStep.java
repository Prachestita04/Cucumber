...
public class VegetableBuyStep {

    @Given("User wants to select {string} and {string} to buy")
    ...
    @When("User select {string} and {string} from that app")
